...
import calculateNumberOfVotesByUser from "./calculateNumberOfVotesFromUser";
...
it("should return the number of votes in total from a user", () => {
  ...
  expect(calculateNumberOfVotesByUser(options, "1")).toBe(6);
});

it("should return 0 if no votes", () => {
  const options = generateOptionsWithVotes("1", [0, 0, 0]);
  expect(calculateNumberOfVotesByUser(options, "1")).toBe(0);
});

it("can handle only 1 vote", () => {
  const options = generateOptionsWithVotes("1", [4]);
  expect(calculateNumberOfVotesByUser(options, "1")).toBe(4);
});
...
it("can handle 4 options", () => {
  ...
  expect(calculateNumberOfVotesByUser(options, "1")).toBe(22);
});
